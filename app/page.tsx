          ...
          <div className="contact-methods">
            ...
            <Link href="https://wa.me/2348061447290" target="_blank" className="contact-card">
              <div className="contact-card-inner">
                <div className="contact-icon">
                  <svg viewBox="0 0 24 24" fill="currentColor">
                    <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.67-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.076 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421-7.403h-.004a9.87 9.87 0 00-5.031 1.378l-.361.214-3.741-.982.998 3.645-.235.374a9.86 9.86 0 00.732 5.1 9.92 9.92 0 00.2.331 10.745 10.745 0 001.617 1.996 9.9 9.9 0 003.806 2.07l.573.161c1.656.469 3.448.527 5.114.147 8.775-1.98 14.588-10.318 12.608-19.092-1.98-8.775-10.317-14.588-19.092-12.608-.565.128-1.124.289-1.677.463L2.581 2.591c-.467 1.666-.425 3.458.147 5.114 1.079 8.024 7.61 14.055 15.634 14.055.844 0 1.682-.055 2.51-.165l.183-.025z"/>
                  </svg>
                </div>
                <h4>WhatsApp</h4>
                <p>Chat with me</p>
